...
.skip_sound_update:
	...
	jp z, .soft_reset
	call MainLoop_IncrementCountersAfterVBlank
	jp MainLoop
...
MainLoop_IncrementCountersAfterVBlank:
	halt
...
UnknownCall_0x0361:
	...
	ld hl, MBC1SRamEnable
	ld a, SRAM_ENABLE
	ld [hl], a ;enable SRAM
	ld h, HIGH(MBC1SRamBank)
	ld a, 0
	ld [hl], a ;Ram Bank 0
	ld h, HIGH(MBC1ModeSelect)
	ld a, 1
...
UnknownCall_0x2202:
	...
	ld a, 0
	ldh [hVBlankCopyDst], a
	ld a, 139
	ldh [hVBlankCopyDst+1], a
	ld a, 128
	ldh [hVBlankCopyLen], a
	ld a, 3
	ldh [hVBlankCopyLen+1], a
...
VBlankCopy:
	ld a, [$A265]
	ld [MBC1RomBank], a
	ldh a, [hVBlankCopyLen]
	ld c, a
	ldh a, [hVBlankCopyLen+1]
	ld b, a
	ldh a, [hVBlankCopySrc]
	ld l, a
	ldh a, [hVBlankCopySrc+1]
	ld h, a
	ldh a, [hVBlankCopyDst]
	ld e, a
	ldh a, [hVBlankCopyDst+1]
	ld d, a
...
LoadTitleScreenTiles:
	...
	ld [sRomBank], a
	ld [MBC1RomBank], a
	ld bc, GFX_TitleScreen_End - GFX_TitleScreen
...
UnknownCall_0x2C61:
	jpba UnknownJump_0x5D25

UnknownCall_0x2C6C:
	jpba UnknownJump_0x5960

UnknownCall_0x2C77:
	jpba UnknownJump_0x591F

UnknownCall_0x2C82:
	jpba UnknownJump_0x5997
...
UnknownJump_0x2CA3::
	jpba UnknownJump_0x68528

UnknownNothing_0x2CAE::
	jpba UnknownJump_0x68000
...
UnknownCall_0x2D0A:
	jpba UnknownJump_0x530D

UnknownCall_0x2D15:
	jpba UnknownJump_0x5550
